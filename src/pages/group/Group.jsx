...
const GroupList = () => {
  ...
  const groupStatusEnum = {
    forbidden: { text: '禁用', status: 'Error' },
  ...
  return (
    <>
      ...
      >
        ...
        <ProFormSelect
          name="creator_uid"
          label={t('group.creator_uid')}
          placeholder={t('code_generator.please_select', {
            name: t('group.creator_uid'),
          })}
          width="xl"
          valueEnum={{}}
          rules={[
        ...
        <ProFormSelect
          name="group_status"
          label={t('group.group_status')}
          placeholder={t('code_generator.please_select', {
            name: t('group.group_status'),
          })}
          width="xl"
          valueEnum={groupStatusEnum}
          rules={[
